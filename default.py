...
addon = xbmcaddon.Addon(id='plugin.video.JCastroIPTV')

dc={"CARACOL TV" : "001", "1+1" : "002"}
try:
...
fanart = os.path.join( addon.getAddonInfo('path'), "fondo.jpg" )
LstDir = ru(os.path.join( addon.getAddonInfo('path'), "playlists" ))
ImgPath = os.path.join( addon.getAddonInfo('path'), )
